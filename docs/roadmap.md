...
Have an idea? [Open a feature request](https://github.com/jtenniswood/esphome-media-player/issues/new) on GitHub.

## Planned

| Feature | Description |
| ------- | ----------- |
| Media Browsing | Browse and select media directly from the display |
